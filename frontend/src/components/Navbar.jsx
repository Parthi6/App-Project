...
const Navbar = () => {
    ...
    // Toggle showSearch state when the search icon is clicked
    const handleSearchToggle = () => {
        setShowSearch((prevState) => !prevState); // Toggle showSearch state
    };
    ...
    return (
        <div className="flex items-center justify-between py-5 font-medium">
            ...
            <div className="flex items-center gap-6">
                ...
                <img
                    onClick={handleSearchToggle} // Toggle showSearch state on click
